...
def main():
    ...
    with SM:
        ...
        smach.StateMachine.add('SELECT_POSE_TO_APPROACH', select_pose_to_approach(),
            transitions={'succeeded':'SWITCH_TO_NAV_CTRL_MODE'})

        smach.StateMachine.add('SWITCH_TO_NAV_CTRL_MODE', switch_to_navigation_ctrl_in_orocos(),
            transitions={'succeeded':'MOVE_TO_GRASP_POSE',
                         'srv_call_failed':'SWITCH_TO_NAV_CTRL_MODE'})
        ...
        smach.StateMachine.add('PLACE_OBJECT_ON_REAR_PLATFORM', place_obj_on_rear_platform(),
            transitions={'succeeded':'SELECT_POSE_TO_APPROACH', 
                        'no_more_free_poses':'SWITCH_TO_NAV_CTRL_MODE2'})

        
        # place object at destination pose
        smach.StateMachine.add('SWITCH_TO_NAV_CTRL_MODE2', switch_to_navigation_ctrl_in_orocos(),
            transitions={'succeeded':'MOVE_TO_DESTINATION_POSE',
                         'srv_call_failed':'SWITCH_TO_NAV_CTRL_MODE2'})
        ...
        smach.StateMachine.add('MOVE_ARM_OUT_OF_VIEW2', move_arm_out_of_view(),
                transitions={'succeeded':'SWITCH_TO_NAV_CTRL_MODE3'})

        smach.StateMachine.add('SWITCH_TO_NAV_CTRL_MODE3', switch_to_navigation_ctrl_in_orocos(),
            transitions={'succeeded':'MOVE_TO_EXIT',
                         'srv_call_failed':'SWITCH_TO_NAV_CTRL_MODE3'})
