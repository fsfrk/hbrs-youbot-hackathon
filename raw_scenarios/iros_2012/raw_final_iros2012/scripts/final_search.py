...
SM_SEARCH = smach.StateMachine(outcomes=['overall_success', 'overall_failed', 'missing_service'])

SM_SEARCH.userdata.source_bin_id = "B1"
SM_SEARCH.userdata.task_workstation = "S1"
SM_SEARCH.userdata.source_workstation = "S1"
SM_SEARCH.userdata.destination_workstation = "S1"
